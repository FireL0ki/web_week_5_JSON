...
let windSpeed = weather.list[0].wind.speed  // need to use [0] to specify which item in the array
// in this case, the array has only one object, so the object is in the first, or [0] index
